...
public class Main {
    public static void main(String[] args) {
        ...
        res = traverse(map, "start", new ArrayList<>());

        System.out.println(res);
        putOnClipboard(Long.toString(res));
    }

    public static long traverse(Map<String, List<String>> map, String src, List<String> visited) {
        if (src.equals("end")) {
            return 1;
        }
        ...
        for (String s : map.get(src)) {
            ...
            long tempres = traverse(map, s, list);
            total += tempres;
        }
        return total;
    }
